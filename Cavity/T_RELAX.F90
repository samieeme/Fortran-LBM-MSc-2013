...
SUBROUTINE RELAX_T(OMEGA_T,LX,LY,NODE_T,N_HLP,N_HLP_T,NODID)
...
!..........AXIS SPEEDS (FACTOR: T_1)
            ...
            N_EQU(1) = T_1 * T_LOC * (3.D0 / 2.D0 + 3.D0 * U_N(1) / ( 2.D0 * C_SQU ) + 9.D0 / 2.D0 * (U_N(1) / C_SQU) * (U_N(1) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU)) 

            N_EQU(2) = T_1 * T_LOC * (3.D0 / 2.D0 + 3.D0 * U_N(2) / ( 2.D0 * C_SQU ) + 9.D0 / 2.D0 * (U_N(2) / C_SQU) * (U_N(2) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

            N_EQU(3) = T_1 * T_LOC * (3.D0 / 2.D0 + 3.D0 * U_N(3) / ( 2.D0 * C_SQU ) + 9.D0 / 2.D0 * (U_N(3) / C_SQU) * (U_N(3) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

            N_EQU(4) = T_1 * T_LOC * (3.D0 / 2.D0 + 3.D0 * U_N(4) / ( 2.D0 * C_SQU ) + 9.D0 / 2.D0 * (U_N(4) / C_SQU) * (U_N(4) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

!..........DIAGONAL SPEEDS (FACTOR: T_2)

            N_EQU(5) = T_2 * T_LOC * (3.D0 + 6.D0 * U_N(5) / C_SQU + 9.D0 / 2.D0 * (U_N(5) / C_SQU) * (U_N(5) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

            N_EQU(6) = T_2 * T_LOC * (3.D0 + 6.D0 * U_N(6) / C_SQU + 9.D0 / 2.D0 * (U_N(6) / C_SQU) * (U_N(6) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

            N_EQU(7) = T_2 * T_LOC * (3.D0 + 6.D0 * U_N(7) / C_SQU + 9.D0 / 2.D0 * (U_N(7) / C_SQU) * (U_N(7) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))

            N_EQU(8) = T_2 * T_LOC * (3.D0 + 6.D0 * U_N(8) / C_SQU + 9.D0 / 2.D0 * (U_N(8) / C_SQU) * (U_N(8) / C_SQU) - 3.D0 / 2.D0 * (U_SQU / C_SQU) * (U_SQU / C_SQU))
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
